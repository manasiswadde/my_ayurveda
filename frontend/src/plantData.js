export const plants = [
  {
    ...
    uses: ['Treats ulcers', 'diarrhea', 'respiratory disorders'],
    medicinalProperties: ['Anti-inflammatory', 'Analgesic', 'Antioxidant']
  },
  {
    id: 2,
    name: 'Aloe Vera',
    ...
    uses: ['Treats skin conditions', 'promotes digestion', 'hydrates the skin'],
    medicinalProperties: ['Healing', 'Soothing', 'Anti-inflammatory']
  },
  {
    id: 3,
    name: 'Amla',
    ...
    uses: ['Boosts immunity', 'improves digestion', 'promotes hair growth'],
    medicinalProperties: ['Antioxidant', 'Immunomodulator', 'Digestive']
  },
  {
    id: 4,
    name: 'Arjuna',
    ...
    uses: ['Supports heart health', 'reduces cholesterol', 'improves circulation'],
    medicinalProperties: ['Cardioprotective', 'Hypolipidemic', 'Antioxidant']
  },
  {
    id: 5,
    name: 'Ashwagandha',
    ...
    uses: ['Reduces anxiety', 'boosts energy', 'enhances cognitive function'],
    medicinalProperties: ['Adaptogen', 'Anti-stress', 'Nootropic']
  },
  {
    id: 6,
    name: 'Bitter Melon',
    ...
    uses: ['Helps manage diabetes', 'improves skin health', 'aids digestion'],
    medicinalProperties: ['Hypoglycemic', 'Antioxidant', 'Digestive']
  },
  {
    id: 7,
    name: 'Boswellia',
    ...
    uses: ['Treats arthritis', 'improves joint health', 'reduces inflammation'],
    medicinalProperties: ['Anti-inflammatory', 'Analgesic', 'Joint health']
  },
  {
    id: 8,
    name: 'Brahmi',
    ...
    uses: ['Improves memory', 'reduces anxiety', 'promotes mental clarity'],
    medicinalProperties: ['Nootropic', 'Anti-anxiety', 'Neuroprotective']
  },
  {
    id: 9,
    name: 'Cardamom',
    ...
    uses: ['Aids digestion', 'freshens breath', 'improves respiratory health'],
    medicinalProperties: ['Carminative', 'Digestive', 'Antioxidant']
  },
  {
    id: 10,
    name: 'Costus Igneus',
    ...
    uses: ['Helps manage diabetes', 'improves insulin sensitivity'],
    medicinalProperties: ['Hypoglycemic', 'Insulin sensitizer']
  },
  {
    id: 11,
    name: 'Cumin',
    ...
    uses: ['Aids digestion', 'boosts immunity', 'improves skin health'],
    medicinalProperties: ['Digestive', 'Antioxidant', 'Immunomodulator']
  },
  {
    id: 12,
    name: 'Gotu Kola',
